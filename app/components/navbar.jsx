...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 nav-backdrop py-4 
                flex items-center justify-between transition-all duration-300
                ${isScroll ? 'bg-white/70 backdrop-blur-md shadow-[0_4px_6px_rgba(255,255,255,0.7]' : ''}`}> 
                <a href="#top">
            ...
            w-64 z-5- h-screen bg-rose-50 transition duration-500">
